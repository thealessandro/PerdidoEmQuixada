...
public class LugaresDeQuixada {
	...
	public ArrayList<Lugar> getLugaresDeQuixada(){
		...
		lugares.add(new Lugar("Raízes Bar & Restô", Tipo.RESTAURANTE, "Comida regional e música ao vivo", -4.969796,-39.014659, "Rua Rodrigues Júnior - Centro (Em frente ao Banco do Brasil)"));
		...
		lugares.add(new Lugar("Mac Lanches", Tipo.LANCHONETE, "Lanchonete", -4.9697,-39.013342, "Rua Rodrigues Júnior – Centro (Em frente a Praça Coronel Nanan)"));
		lugares.add(new Lugar("Nori", Tipo.RESTAURANTE, "Restaurante Asiático", -4.969772,-39.013401, "Rua Rodrigues Júnior, 759 - Centro"));
		lugares.add(new Lugar("Sorveteria Mix", Tipo.SORVETERIA, "Sorveteria", -4.969769,-39.016126, "Rua Rodrigues Júnior – Centro (Esquina com a Praça José de Barros)"));
		lugares.add(new Lugar("Q-doce", Tipo.LANCHONETE, "Lanchonete", -4.968622, -39.016185, "Rua Epitácio Pessoa, 1453 – Centro"));
		lugares.add(new Lugar("Bom D+", Tipo.RESTAURANTE, "Pizzaria e churrascaria", -4.968543,-39.015, "Rua Epitácio Pessoa, 1322 - Centro"));
		...
		lugares.add(new Lugar("Pizzaria Forno A Lenha", Tipo.PIZZARIA, "Pizzaria", -4.969307, -39.013366, "Rua Clarindo de José - Centro"));
		...
		lugares.add(new Lugar("Abrigo Bar", Tipo.BAR, "Bar", -4.96928, -39.013444, "Rua Clarindo de José - Centro"));
		...
		lugares.add(new Lugar("Le Gourmet Buffet Sushi", Tipo.RESTAURANTE, "Restaurante Asiático", -4.970707,-39.025578, "Rua José Freitas Queirós – Planalto Universitário"));
		...
		lugares.add(new Lugar("Pinheiro Supermercado", Tipo.SUPERMERCADO, "Supermercado", -4.968316,-39.017392, "Rua Francisco Enéas de Lima, 2027 – Centro")); 
		lugares.add(new Lugar("Lojas Americanas", Tipo.LOJA_DE_DEPARTAMENTO, "Loja de departamento", -4.968527,-39.014308, "Rua Epitácio Pessoa, 1250  - Centro"));
		lugares.add(new Lugar("Super São Geraldo Centro", Tipo.SUPERMERCADO, "Supermercado", -4.968893,-39.016917, "Rua Tabelião Enéas, 645 – Centro"));
		lugares.add(new Lugar("Super São Geraldo Alto São Francisco", Tipo.SUPERMERCADO, "Supermercado", -4.968543,-39.010244, "Rua Epitácio Pessoa, 783 – Alto São Francisco"));
		lugares.add(new Lugar("Super São Geraldo Campo Novo", Tipo.SUPERMERCADO, "Supermercado", -4.982256,-39.018682, "Av. Presidente Vargas, 740 – Campo Novo"));
		...
		lugares.add(new Lugar("Panificadora Nossa Senhora do Perpétuo Socorro", Tipo.PADARIA, "Padaria", -4.967394,-39.008906, "Rua Benjamim Constant, 1033 – Alto São Francisco"));
		lugares.add(new Lugar("Meu Escritório", Tipo.BAR, "Bar", -4.972644,-39.019565, "Av. José Caetano Almeida - Combate"));
		lugares.add(new Lugar("Hotel Nobile Express Vale das Pedras", Tipo.HOTEL, "Hotel com 130 leitos. Tel: (88) 3412-6610(Recepção) e (88) 3412- 6611 (Reservas)", -4.955997,-39.006942, "Av. Jesus Maria e José, 2010 – Jardim dos Monólitos"));
		lugares.add(new Lugar("Panificadora Q-Pão", Tipo.PADARIA, "Padaria", -4.968599,-39.014962, "Rua Epitácio Pessoa, 1325 – Centro"));
		lugares.add(new Lugar("Self-Service Saborear", Tipo.RESTAURANTE, "Restaurante", -4.969775,-39.015756, "Rua Rodrigues Júnior, 1342 – Centro"));
		lugares.add(new Lugar("Peixada O Abelardo", Tipo.RESTAURANTE, "Peixada, tilápia frita, camarão, baião de dois, etc.", -4.962918,-39.015474, "Av. Placido Castelo, 2585 – Triângulo"));
		...
		lugares.add(new Lugar("Panificadora Uberlândia", Tipo.PADARIA, "Padaria", -4.968639,-39.020791, "Rua José de Queirós Pessoa – Planalto Universitário"));
		lugares.add(new Lugar("O Rei do Lanche", Tipo.RESTAURANTE, "Restaurante bom e barato (feito para universitários)", -4.97343,-39.016816, "Rua Sebastião Enéas – Centro (atrás da rodoviária)"));
		lugares.add(new Lugar("Mr. Mix Milk Shakes", Tipo.SORVETERIA, "Sorveteria", -4.969785,-39.016293, "Av. Plácido Castelo – Centro (próximo da Sorveteria Mix)")); 
		...
		lugares.add(new Lugar("Hotel Monólitos", Tipo.HOTEL, "Hotel com 50 leitos. Tel: (88) 3412-8080", -4.97234,-39.016504, "Av. Plácido Castelo – Centro"));
		lugares.add(new Lugar("Hotel Belas Artes", Tipo.HOTEL, "Hotel com 80 leitos. Tel: (88) 3412-0188", -4.995656,-39.032021, "Estrada do Algodão, km 96"));
		...
		lugares.add(new Lugar("Banco do Brasil", Tipo.BANCO, " Tel: (88) 3412-0034", -4.969718,-39.014458, "Rua Rodrigues Júnior, 1202 – Centro"));
		...
		lugares.add(new Lugar("Drogarias Feitosa", Tipo.FARMACIA, "Farmácia", -4.969758,-39.016038, "Rua Rodrigues Júnior, 1372 – Centro"));
		lugares.add(new Lugar("Extrafarma", Tipo.FARMACIA, "Farmácia", -4.968952,-39.016824, "Rua Tabelião Enéas, 628 – Centro"));
		lugares.add(new Lugar("Farmácia Menino Jesus", Tipo.FARMACIA, "Farmácia", -4.969777,-39.012682, "Rua Rodrigues Júnior, 1005 – Irajá"));
		...
		lugares.add(new Lugar("Hospital Maternidade Jesus Maria José", Tipo.HOSPITAL, "Tel: (88) 3412-0681", -4.967586, -39.024964, "Av. Francisco Almeida Pinheiro, 2268 – Planalto Universitário"));
